...
import './signUp.css'
import FormatForm1 from "./StratefulForm1";
...
function SignUp() {
    ...
    const [selected2, setSelected2] = useState('01 Passengers')
    const howPasssengers = ['01 Passengers', '02 Passengers', '03 Passengers', '04 Passengers']

    const [selected3, setSelected3] = useState('Business Class')
    const classOfPlace = ['Business Class, Medium Class, Econom Class']

    const toggleType = () => {
      setShowType(prev => ({...prev, isShow: !prev.isShow, id:0}))
    }
    ...
    <main className="main1">
      {/* <div className="signUp">
        ...
        <button className="signUpButton" onClick={tuggleBuggle}>
          {click ? 'Request have sended' : 'Sign Up'}
        </button>
      </div> */}
      <FormatForm1 />
    </main>
